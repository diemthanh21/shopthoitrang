...
describe('index.test.ts', () => {
    describe('mixed', () => {
        ...
        it('nested omitFields handling', () => {
            ...
            chai_1.expect(swagger.properties._id).to.be.undefined;
            chai_1.expect(swagger.properties.a.properties._id).to.be.undefined;
            chai_1.expect(swagger.properties.a.properties.b._id).to.be.undefined;
        });
    ...
    describe('documentModel', () => {
        ...
        it('should respect omitMongooseInternals option', () => {
            ...
            const results = getFieldsFromMongooseSchema(schema, {
                props: [],
                omitFields: [],
            ...
            chai_1.expect(idField.type, 'idField.type').to.exist;
            chai_1.expect(idField.type).to.equal('string');
            const vField = results.find(x => x.field === '__v');
            chai_1.expect(vField.type, 'vField.type').to.exist;
            chai_1.expect(vField.type).to.equal('number');
            ...
            chai_1.expect(props.name).to.exist;
            chai_1.expect(props.id).to.exist;
            chai_1.expect(props._id).to.exist;
            chai_1.expect(props.__v).to.exist;
            ...
            chai_1.expect(propsPartialOmit.name).to.exist;
            chai_1.expect(propsPartialOmit.id).to.exist;
            chai_1.expect(propsPartialOmit._id).to.exist;
            chai_1.expect(propsPartialOmit.__v).to.not.exist;
            const propsFullOmit = documentModel({
                schema,
            }, {
                omitMongooseInternals: true,
            }).properties;
            chai_1.expect(propsFullOmit.name).to.exist;
            chai_1.expect(propsFullOmit.id).to.not.exist;
            chai_1.expect(propsFullOmit._id).to.exist;
            chai_1.expect(propsFullOmit.__v).to.not.exist;
        });
        it('other various types', () => {
            ...
            schema.virtual('f', () => 'b');
            const results = getFieldsFromMongooseSchema(schema, { props: [], omitFields: [] });
            const nameField = results.find(x => x.field === 'name');
            chai_1.expect(nameField.type, 'nameField.type').to.exist;
            chai_1.expect(nameField.type).to.equal('string');
    ...
    describe('configurable meta fields', () => {
        ...
        it('id should be excluded by default', () => {
            ...
            chai_1.expect(result.properties).to.not.have.keys('id');
            chai_1.expect(result.properties).to.have.keys('_id');
        });
    });
