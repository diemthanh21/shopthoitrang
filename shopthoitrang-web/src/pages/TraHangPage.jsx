...
import { ArrowUpRight, RefreshCcw, Search, Eye } from "lucide-react";
      ...
      case "cho_duyet":
        return (
          <div className="flex flex-wrap gap-2">
            {detailButton}
            <ActionButton tone="emerald" onClick={() => openDialog("accept", id)}>
              Duyệt
            </ActionButton>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => navigate('/trahang/create')}
                  ...
                  return (
                    <tr key={item.maTraHang || item.id} className="transition hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">
                        {item.tenSanPham || `CTSP #${item.maChiTietSanPham ?? "?"}`}
                      </td>
