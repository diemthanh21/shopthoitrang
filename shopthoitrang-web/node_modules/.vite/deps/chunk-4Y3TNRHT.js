...
var WarningContext = React4.createContext({});
var devUseWarning = true ? (component) => {
  const {
    strict
  } = React4.useContext(WarningContext);
...
var useLocale = (componentName, defaultLocale) => {
  const fullLocale = React13.useContext(context_default);
  const getLocale = React13.useMemo(() => {
    var _a;
  ...
  const getLocaleCode = React13.useMemo(() => {
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React14.useMemo(() => Object.assign(Object.assign({}, locale5), {
    exist: true
  }), [locale5]);
  return React14.createElement(context_default.Provider, {
...
var SizeContext = React16.createContext(void 0);
var SizeContextProvider = ({
  children,
  size
}) => {
  const originSize = React16.useContext(SizeContext);
  return React16.createElement(SizeContext.Provider, {
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-4Y3TNRHT.js.map
