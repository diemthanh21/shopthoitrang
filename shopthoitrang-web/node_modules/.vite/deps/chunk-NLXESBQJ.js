...
var Switch = React.forwardRef(function(_ref, ref) {
  ...
  var switchClassName = (0, import_classnames.default)(prefixCls, className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-checked"), innerChecked), _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _classNames));
...
var style_default = genStyleHooks("Switch", (token) => {
...
var InternalSwitch = React2.forwardRef((props, ref) => {
  const {
  ...
  const disabled = React2.useContext(DisabledContext_default);
  const mergedDisabled = (customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled) || loading;
  const prefixCls = getPrefixCls("switch", customizePrefixCls);
  const loadingIcon = React2.createElement("div", {
    className: `${prefixCls}-handle`
  }, loading && React2.createElement(LoadingOutlined_default, {
    className: `${prefixCls}-loading-icon`
  }));
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls);
  const mergedSize = useSize_default(customizeSize);
  const classes = (0, import_classnames2.default)(SWITCH === null || SWITCH === void 0 ? void 0 : SWITCH.className, {
  ...
  return wrapCSSVar(React2.createElement(wave_default, {
    component: "Switch",
    disabled: mergedDisabled
  }, React2.createElement(es_default, Object.assign({}, restProps, {
    checked,
...
//# sourceMappingURL=chunk-NLXESBQJ.js.map
