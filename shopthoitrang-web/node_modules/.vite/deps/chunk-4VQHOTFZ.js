...
function Mask(props) {
  ...
  return React2.createElement(es_default2, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
    ...
    return React2.createElement("div", {
      ...
      className: (0, import_classnames2.default)("".concat(prefixCls, "-mask"), className)
    });
  });
}
...
var PopupContent = React3.memo(function(_ref) {
...
var Popup = React4.forwardRef(function(props, ref) {
  ...
  var _React$useState = React4.useState(!getPopupContainer || !getPopupContainerNeedParams), _React$useState2 = _slicedToArray(_React$useState, 2), show = _React$useState2[0], setShow = _React$useState2[1];
  ...
  return React4.createElement(Portal, {
    ...
    autoDestroy
  }, React4.createElement(Mask, {
    prefixCls,
    open,
    zIndex,
    mask,
    motion: maskMotion
  }), React4.createElement(es_default, {
    onResize: onAlign,
    disabled: !open
  }, function(resizeObserverRef) {
    return React4.createElement(es_default2, _extends({
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
      removeOnLeave: false,
      ...
      var cls = (0, import_classnames3.default)(prefixCls, motionClassName, className);
      ...
      }, arrow && React4.createElement(Arrow, {
        prefixCls,
        arrow,
        arrowPos,
        align
      }), React4.createElement(PopupContent_default, {
        cache: !open && !fresh
      }, childNode));
    });
  }));
...
var TriggerWrapper = React5.forwardRef(function(props, ref) {
  var children = props.children, getTriggerDOMNode = props.getTriggerDOMNode;
  var canUseRef = supportRef(children);
  var setRef = React5.useCallback(function(node) {
    fillRef(ref, getTriggerDOMNode ? getTriggerDOMNode(node) : node);
  }, [getTriggerDOMNode]);
  var mergedRef = useComposeRef(setRef, getNodeRef(children));
  return canUseRef ? React5.cloneElement(children, {
    ref: mergedRef
  }) : children;
});
if (true) {
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  var openRef = React9.useRef(open);
  openRef.current = open;
  var popupPointerDownRef = React9.useRef(false);
...
function generateTrigger() {
  ...
  var Trigger = React10.forwardRef(function(props, ref) {
    ...
    var _React$useState = React10.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mobile = _React$useState2[0], setMobile = _React$useState2[1];
    useLayoutEffect_default(function() {
      setMobile(isMobile_default());
    }, []);
    var subPopupElements = React10.useRef({});
    var parentContext = React10.useContext(context_default);
    ...
    var _React$useState3 = React10.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), popupEle = _React$useState4[0], setPopupEle = _React$useState4[1];
    var externalPopupRef = React10.useRef(null);
    ...
    var _React$useState5 = React10.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), targetEle = _React$useState6[0], setTargetEle = _React$useState6[1];
    var externalForwardRef = React10.useRef(null);
    ...
    var child = React10.Children.only(children);
    ...
    var _React$useState7 = React10.useState(defaultPopupVisible || false), _React$useState8 = _slicedToArray(_React$useState7, 2), internalOpen = _React$useState8[0], setInternalOpen = _React$useState8[1];
    ...
    var openRef = React10.useRef(mergedOpen);
    openRef.current = mergedOpen;
    var lastTriggerRef = React10.useRef([]);
    ...
    var _React$useState9 = React10.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), inMotion = _React$useState10[0], setInMotion = _React$useState10[1];
    useLayoutEffect_default(function(firstMount) {
      if (!firstMount || mergedOpen) {
        setInMotion(true);
      }
    }, [mergedOpen]);
    var _React$useState11 = React10.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), motionPrepareResolve = _React$useState12[0], setMotionPrepareResolve = _React$useState12[1];
    var _React$useState13 = React10.useState(null), _React$useState14 = _slicedToArray(_React$useState13, 2), mousePos = _React$useState14[0], setMousePos = _React$useState14[1];
    ...
    var alignedClassName = React10.useMemo(function() {
      var baseClassName = getAlignPopupClassName(builtinPlacements, prefixCls, alignInfo, alignPoint);
      return (0, import_classnames4.default)(baseClassName, getPopupClassNameFromAlign === null || getPopupClassNameFromAlign === void 0 ? void 0 : getPopupClassNameFromAlign(alignInfo));
    ...
    var _React$useState15 = React10.useState(0), _React$useState16 = _slicedToArray(_React$useState15, 2), targetWidth = _React$useState16[0], setTargetWidth = _React$useState16[1];
    var _React$useState17 = React10.useState(0), _React$useState18 = _slicedToArray(_React$useState17, 2), targetHeight = _React$useState18[0], setTargetHeight = _React$useState18[1];
    ...
    if (className) {
      cloneProps.className = (0, import_classnames4.default)(originChildProps.className, className);
    }
    var renderedRef = React10.useRef(false);
    ...
    var triggerNode = React10.cloneElement(child, _objectSpread2(_objectSpread2({}, mergedChildrenProps), passedProps));
    var arrowPos = {
      x: arrowX,
      y: arrowY
    };
    var innerArrow = arrow ? _objectSpread2({}, arrow !== true ? arrow : {}) : null;
    return React10.createElement(React10.Fragment, null, React10.createElement(es_default, {
      disabled: !mergedOpen,
      ref: setTargetRef,
      onResize: onTargetResize
    }, React10.createElement(TriggerWrapper_default, {
      getTriggerDOMNode
    }, triggerNode)), renderedRef.current && React10.createElement(context_default.Provider, {
      value: context
    }, React10.createElement(Popup_default, {
      portal: PortalComponent,
      ref: setPopupRef,
      prefixCls,
      popup,
      className: (0, import_classnames4.default)(popupClassName, alignedClassName),
      style: popupStyle,
      target: targetEle,
...
//# sourceMappingURL=chunk-4VQHOTFZ.js.map
